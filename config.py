...
#Export Config
RESULTS_FILE_NAME_EXCEL =  f"results_BC-EXCHANGE_MARKET_{ENABLE_EXCHANGE_MARKET}-PRL_MARKET_{ENABLE_PRL_MARKET}-{BATTERY_CAPACITY}MWH_SCR-{SYSTEM_POWER}MW_P-{BATTERY_PRICE}€_LC-{LIFETIME_CYCLES}n_n-{EFFICIENCY}%_{START_DATE}to{END_DATE}.xlsx"
RESULTS_FILE_NAME_PICKLE = f"results_BC-EXCHANGE_MARKET_{ENABLE_EXCHANGE_MARKET}-PRL_MARKET_{ENABLE_PRL_MARKET}-{BATTERY_CAPACITY}MWH_SCR-{SYSTEM_POWER}MW_P-{BATTERY_PRICE}€_LC-{LIFETIME_CYCLES}n_n-{EFFICIENCY}%_{START_DATE}to{END_DATE}.pkl"
