...
def main_optimisation(df_data_period):
    ...
    model = setup_model(time_points, higher_market_price_dict, lower_market_price_dict, prl_price_dict, srl_power_price_neg_dict, srl_power_price_pos_dict, srl_work_price_neg_dict, srl_work_price_pos_dict, charge_rate)
    solve_model(model)
